...
class MailTransport {
	...
	sendMail = (subject: string, html: string): Promise<any> => this._transport.sendMail(Object.assign<SendMailOptions, SendMailOptions>({ subject, html }, this._defaultConfig));
}
